...
| Изоҳ блоки | `.wcard__note` | тўлиқ кенглик 320, падинг 8 10, радиус 12, ≤ 2 қатор (`line-clamp`), баландлик 31 / 46 | 500 12/15 | матн `--c-text`; фон одатий `--c-row` `#F8F8FC`; `--blue` `#E8F6FE`; `--green` `#ECFFDE`; `--pink` `#FFE4EA` |
| Асосий тугма | `.wcard__btn` | баландлик 36, радиус 12, падинг 0 14, кенглик 320 (робот бўлса 248) | 600 13/16 | фон `--c-brand` `#FF4F28`, матн `#FFFFFF` |
...
Баландлик бюджети (ҳар ҳолатда): сарлавҳа 18 + кичик сатр 17 = 35 → 8 → изоҳ ≤ 46 → 8 → тугма 36 = **133 ≤ 168**. Тана 81 pt жой олади (168 − 35 − 8 − 8 − 36 = 81; ўлчам катталашувидан келган қўшимча 14 pt айнан шу flex танага тушади), изоҳ 46 дан ошмайди (2 қаторли клэмп).

Робот геометрияси: `robot2` 64 pt қути y = 120…184, кўринадиган пикселлар y ≈ 125 дан (расм 512×427, вертикал марказланган); `robot5`/`robot7` 60 pt қути y = 124…184. Изоҳ y = 55…101 да тугайди (юқоридан ўсади, ўзгармади) → робот изоҳга тегмайди; тугма 248 pt кенгликда роботдан чапда.
...
| `loading` | Фақат биринчи юклашда, кэшда ҳолат йўқ бўлса (presence + охирги хабар сўрови кетяпти) | Скелет: сарлавҳа 118×16, кичик сатр 88×12, чип 72×22 пилл, изоҳ 320×46, тугма 320×36. Робот йўқ | — | — |
...
Матн узунлиги текшируви: сарлавҳа 14 белги (≤ 22); кичик сатрлар 12–23 UZ / 12–26 RU (≤ 30); чиплар 5–12 белги; тугмалар UZ 11–14, RU 8–18 белги («У меня есть вопрос» = 18, чегарада — `locked` да иконкасиз қолдирилди, 265 pt га сиғади); изоҳлар 39–61 белги, савол/жавоб клэмп билан кесилади. Сарлавҳа қатори энг кенг ҳолати `pending`: UZ ≈ 252/320 pt, RU («Отправлено: сегодня, 14:20» + «В ожидании») ≈ 270/320 pt — чегарада; рус тилида кичик сатрни «Сегодня, 14:20» деб қисқартириш мумкин.
...
- **Рус тили:** «У меня есть вопрос» тугма матни 18 белги — 248 pt тугмага сиғади (матн эни ≈ 154 pt), лекин катта шрифт масштабида «Задать вопрос» га тушириш кўзда тутилсин.
