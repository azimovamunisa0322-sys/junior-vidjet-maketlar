...
Карточка `.wcard`: 344×192 pt, падинг 12 → ички қути 320×168, радиус `--r-card` 18, фон `--c-card` `#FFFFFF`, соя `--shadow-card`. Тик оқим: сарлавҳа қатори → 8 → тана → 8 → пастки қатор (пастга ёпишган).

| Элемент | Класс | Ўлчам | Шрифт | Ранг |
|---|---|---|---|---|
| Карточка номи | `.wcard__title` | 1 қатор, **21 pt** | 600 **17/21** SF Pro (`--t-title`) | `--c-text` `#000000` |
| Кичик сатр | `.wcard__sub` | 1 қатор, **16 pt**, устидан 2 pt | 500 **13/16** (`--t-small`) | одатий `--c-text-2` `#999999`; `--brand` `#FF4F28`; `--blue` `#1CB0F6`; `--green` `#58CC02`; `--red` `#ED0000` |
| Статус чипи | `.wcard__chip` | баландлик 22, падинг 0 8, пилл, иконка 14 (ёки нуқта 8) + 4 оралиқ | 600 **13/16** | `--green`: фон `#ECFFDE`, матн `#58CC02`; `--brand`: `#FFEDE7`/`#FF4F28`; `--blue`: `#E8F6FE`/`#1CB0F6`; `--pink`: `#FFE4EA`/`#ED0000`; одатий (оффлайн): `#F8F8FC`/`#999999` |
| Онлайн/оффлайн нуқтаси | `.m-dot` | 8×8, доира | — | `currentColor` (чип матни ранги) |
| Изоҳ блоки | `.wcard__note` | тўлиқ кенглик 320, падинг 8 10, радиус 12, ≤ 2 қатор (`line-clamp`), баландлик **32 / 48** (1 / 2 қатор) | 500 **13/16** | матн `--c-text`; фон одатий `--c-row` `#F8F8FC`; `--blue` `#E8F6FE`; `--green` `#ECFFDE`; `--pink` `#FFE4EA` |
| Асосий тугма | `.wcard__btn` | баландлик 36, радиус 12, падинг 0 14, кенглик 320 (робот бўлса 248) | 600 **14/17** (`--t-btn`) | фон `--c-brand` `#FF4F28`, матн `#FFFFFF` |
| Ўчирилган тугма | `.wcard__btn--disabled` | шу ўлчам | 600 **14/17** | фон `--c-line-2` `#F0F0F0`, матн `--c-text-3` `#B4B4B4` |
| Иккиламчи тугма | `.wcard__btn--fit` | кенглиги матн бўйича (~**125**, аввал 116) | 600 **14/17** | бренд апельсин (кейинги қадам) |
...
Баландлик бюджети (ҳар ҳолатда): сарлавҳа **21** + кичик сатр **18** (2 + 16) = **39** → 8 → изоҳ ≤ **48** → 8 → тугма 36 = **139 ≤ 168**. Тана **77** pt жой олади (168 − 39 − 8 − 8 − 36 = 77; сарлавҳа қатори 35 дан 39 га чиққани учун тана 81 дан 77 га тушди — карточка баландлиги ўзгармади), изоҳ **48** дан ошмайди (2 қаторли клэмп: 2×16 + 8 + 8).

Робот геометрияси: `robot2` 64 pt қути y = 120…184, кўринадиган пикселлар y ≈ 125 дан (расм 512×427, вертикал марказланган); `robot5`/`robot7` 60 pt қути y = 124…184. Изоҳ энди y = **59…107** да тугайди (сарлавҳа қатори 4 pt пасайтирди, изоҳнинг ўзи 2 pt узайди) → робот изоҳга **ҳамон тегмайди**, лекин захира 19 дан **13 pt** га тушди. Тугма 248 pt кенгликда роботдан чапда.
...
| `loading` | Фақат биринчи юклашда, кэшда ҳолат йўқ бўлса (presence + охирги хабар сўрови кетяпти) | Скелет: сарлавҳа 118×16, кичик сатр 88×12, чип 72×22 пилл, изоҳ 320×**48**, тугма 320×36. Робот йўқ. (Маketдаги `.m-sk-note` ҳамон 46 pt — ҳақиқий изоҳ 48; иловада 48 қилинсин) | — | — |
...
Матн узунлиги текшируви — **қайта ҳисобланди** (шрифт катталашгани учун ҳамма чегара қисқарди; рақамлар нисбат бўйича тахмин, рендерда текширилсин): сарлавҳа 14 белги (лимит 22 → **19**); кичик сатрлар 12–23 UZ / 12–26 RU (лимит 30 → **27** — RU 26 белги энди **чегарада**); чиплар 5–12 белги; тугмалар UZ 11–14, RU 8–18 белги («У меня есть вопрос» = 18, матн эни 154 → **≈ 166 pt**, 248 pt тугманинг 220 pt ички жойига ҳамон сиғади); изоҳлар 39–61 белги, савол/жавоб клэмп билан кесилади.

> ⚠️ **Сарлавҳа қаторида RU кесилиши мумкин.** Энг кенг ҳолат `pending`: UZ ≈ 252 → **≈ 273/320 pt**, RU («Отправлено: сегодня, 14:20» + «В ожидании») ≈ 270 → **≈ 292/320 pt**. Аввал «чегарада» деб ёзилган эди; 13 pt шрифтда захира ≈ 28 pt қолди, яъни RU да кичик сатр **албатта** «Сегодня, 14:20» деб қисқартирилсин — акс ҳолда чип билан тўқнашади ёки `ellipsis` кесади.
...
| Карточканинг ўзи (сарлавҳа, изоҳ, робот) | бутун 344×192 | Тугма билан бир хил (чатни очади) — веб'дагидек «ўлик» юза қолдирилмайди. `locked` да: toast «Chat to'lovdan keyin ochiladi» (RU «Чат откроется после оплаты»). `loading` да ҳаракат йўқ |
...
- **Тузилиш:** `Stack` → [`Container`(344×192, `BoxDecoration(borderRadius: 18, color: card, boxShadow)`, `Padding(12)`, `Column`(head `Row`, `SizedBox(8)`, body `Expanded`, `SizedBox(8)`, foot `Row`)), `Positioned(right: 8, bottom: 8, child: Image.asset(robot, width: art))`]. Пастки қатор робот бўлса `Padding(right: 72)`.
...
- **Тугмалар:** `FilledButton` (`minimumSize: Size(0, 36)`, `shape: RoundedRectangleBorder(12)`, `textStyle` **600/14 h17**); ўчирилган — `FilledButton` `onPressed: null` эмас (toast бериш учун), `style` `disabled` рангли, `onPressed` toast кўрсатади. Босиш зонаси ≥ 44: `MaterialTapTargetSize.padded` ёки `SizedBox(height: 44)` ичида марказлаш. Бутун карточка — `InkWell`/`GestureDetector`.
- **Токенлар:** `ThemeExtension<JuniorTokens>`: `card #FFFFFF`, `row #F8F8FC`, `text #000000`, `text2 #999999`, `text3 #B4B4B4`, `line2 #F0F0F0`, `brand #FF4F28`, `brandSoft #FFEDE7`, `green #58CC02`, `greenSoft #ECFFDE`, `blue #1CB0F6`, `blueSoft #E8F6FE`, `red #ED0000`, `pinkSoft #FFE4EA`; радиуслар `card 18`, `inner 12`, `btn 12`; матн стиллари **янги шкала** бўйича: `title 600/17 h21`, `body 500/14 h18`, `small 500/13 h16`, `tiny 500/12 h15`, `btn 600/14 h17` (`fontFamily: 'SFpro'`).
...
- **Accessibility:** `Semantics(label: 'Mentor yordami, Aziz Karimov onlayn. Savolim bor')`; чип ва робот `excludeSemantics`. Тизим шрифт масштаби ≥ 1,3 да кичик сатр ва чип бир қаторда сиғмайди — `MediaQuery.textScaler.clamp(maxScaleFactor: 1.3)` карточка ичида. ⚠️ Базавий шрифт 12 дан 13 pt га ўсгани учун бу чегара энди эртароқ уриб қолади (айниқса RU `pending` да) — қурилмада текшириб, керак бўлса **1.2** га туширилсин.
- **Рус тили:** «У меня есть вопрос» тугма матни 18 белги — 248 pt тугмага ҳамон сиғади (матн эни 154 → **≈ 166 pt**, ички жой 220 pt), лекин захира 66 дан 54 pt га тушди; катта шрифт масштабида «Задать вопрос» га тушириш кўзда тутилсин.
