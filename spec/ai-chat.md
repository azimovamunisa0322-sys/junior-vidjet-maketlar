...
| Ким билан гаплашилмоқда | `.scr__sub[data-ai-who]` | 15 pt қатор, `margin-top 4` | 12/500 (`--t-small`) | `--c-text-2` `#999999` | `Aziz Karimov · Blockly Dasturlash` — ментор алмашганда шу ер янгиланади |
...
| Кун ажратгичи | `.ai-day span` | 20 pt (14 + 6), падинг `3 10`, радиус pill | 11/500 (`--t-tiny`) | фон `--c-row` `#F8F8FC`, матн `--c-text-2` `#999999` | Марказда: `Bugun 09:12` |
...
Ҳар қатор — босиладиган `.s-item.ai-pick` (падинг `12 14`, радиус 14, фон `--c-row` `#F8F8FC`, оралиқ 12): чапда **ҳарф-аватар** `.ai-ava` 40×40, радиус 12, фон `--c-brand-soft` `#FFEDE7`, ҳарф 16/600 `--c-brand` `#FF4F28`; ўртада исм (14/600) ва курс (12/500 `#999999`); ўнгда ҳолат. Тўртта ментор + ажратгич (`.s-div` 1 px `--c-line-2` `#F0F0F0`) + `AI yordamchi · 24/7` қатори (ҳарф-аватар ўрнига `.s-item__ic` 36×36 оқ квадрат, ичида `ai.svg` `--c-brand`).
