...
| `.wk` — ҳафта қатори | 320×44 | — | — | ҳар устун қаторнинг 1/7 қисми (320 / 7 = 45,7 pt) — оралиқ қолмайди, устунлар қўшнисига тегиб туради; карточка кенглиги ўзгарса ҳам тақсимот бузилмайди |
...
Баландлик ҳисоби (ички 168 pt): `normal / record / today-pending / frozen-today / lost / loading` = 35 (сарлавҳа + сатр) + 8 + 44 (қатор) + 8 + 36 = **131**, қолган **37 pt** — тананинг (`.wcard__body`, `flex: 1`) бўш жойи, қатор шунинг ичида вертикал марказда; `new-user` = 35 + 8 + 46 (изоҳ) + 8 + 36 = **133**, қолган **35 pt** изоҳнинг остида (тана `--top`); `error` = 18 + 8 + 32 + 8 + 36 = **102**, қолган **66 pt** тананинг бўш жойи. Карточка яна 14 pt баландлашгани тўлиғича шу бўш жойга тушди (23 → 37, 21 → 35, 52 → 66); сарлавҳа + сатр бўлган ҳолатларда тана баландлиги 67 → 81. Ҳеч бир ҳолатда скролл ва кесилиш йўқ.
