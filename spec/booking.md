...
Шрифт шкаласи катталашгандан кейин (`--t-title` 15/18 → **17/21**, `--t-body` 13/16 → **14/18**, `--t-small` 12/15 → **13/16**, `--t-tiny` 11/14 → **12/15**, `--t-btn` 13/16 → **14/17**) сарлавҳа қатори **35 → 39** га (21 + 2 + 16), сатрсиз сарлавҳа эса **18 → 21** га чиқди. Карточка баландлиги `192` ва ички қути `168` **ўзгармади** — фарқ ҳар доим `flex` тана қисмидан олинади.

Баландлик бюджети ҳолат турига қараб:

| Қолип | Ҳолатлар | Ҳисоб |
|---|---|---|
| **Таймерли** | `demo-upcoming`, `demo-today` | сарлавҳа **39** (21 + 2 + 16) + 8 + тана **77** (таймер **55**, устида 11 ва остида 11 pt бўш — `.wcard__body:has(> .wtimer)` марказлаштиради) + 8 + пастки қатор 36 = 168 |
| Изоҳли | `demo-active`, `demo-missed` | сарлавҳа **39** + 8 + тана **77** (изоҳ ≤ **48** = 2×16 + 16, тагида 29 pt бўш) + 8 + 36 = 168 |
| Рўйхатли | `multi` | сарлавҳа **39** + 8 + тана **77** (рўйхат 52, тагида 25 pt бўш) + 8 + 36 = 168 |
| Сатрсиз | `empty`, `error` | сарлавҳа **21** + 8 + тана **95** (матн **18** / хато қатори 40) + 8 + 36 = 168 |
| Скелет | `loading` | сарлавҳа 32 (16 + 4 + 12 — скелет ўлчамлари қатъий, шрифтга боғлиқ эмас) + 8 + тана **84** + 8 + 36 = 168 |

| Элемент | Ўлчам | Шрифт | Ранг | Изоҳ |
|---|---|---|---|---|
| `.wcard__title` | **21 pt** қатор, ≤ **19** белги | `--t-title` 600 **17/21**, letter-spacing −0.1 | `--c-text` `#000000` | `Demo Day`; йиғма/бўш/хато карточкада илова атамаси `Mening bandlovlarim` (19 белги — чегарада, `ellipsis` шарт) |
| `.wcard__sub` | **16 pt** қатор, юқоридан 2 pt, ≤ **27** белги | `--t-small` 500 **13/16** | демо `--c-brand` `#FF4F28` (`--brand`), қолдирилган `--c-red` `#ED0000` (`--red`), йиғма `--c-text-2` `#999999` | Сана ва вақт: `12 sentabr, 14:00`, бугун бўлса `Bugun, 14:00` (Тошкент, қаттиқ UTC+5, 24 соатли). Сана бир марта чиқади — веб `detail_time` такрори йўқ |
| **`.wtimer`** (таймерли ҳолатлар) | 320×**55**, 4 устун `1fr`, ора 6 → ҳар катак `75,5×55` | — | — | Чипнинг ўрнини босди. `data-cd="KK:SS:DD:SS"`, `js/app.js` `tickCountdowns()` ҳар 1 с да 4 та `<b>` ни янгилайди. Танада ягона элемент бўлгани учун `.wcard__body:has(> .wtimer)` уни **марказга** қўяди. Тўлиқ қоида — [`spec/taymer.md`](taymer.md) |
| `.wtimer__b` | 75,5 кенг, падинг `8 0 7`, радиус `--r-inner` 12 | — | фон `--c-row` `#F8F8FC` | 4 та бир хил катак: кун · соат · дақиқа · сония. Баландлик 8 + 28 + 12 + 7 = **55** |
| `.wtimer__b b` (рақам) | **28 pt** қатор | 600 **24/28**, letter-spacing −0.6, `tabular-nums` | `--c-text` `#000000` | Ҳар доим икки хона: `02`, `41` |
| `.wtimer__b span` (ёрлиқ) | **12 pt** қатор | 500 **10/12**, letter-spacing +0.3, UPPERCASE | `--c-text-3` `#B4B4B4` | `kun` · `soat` · `daqiqa` · `soniya`. Энг узуни `soniya` ≈ **43 pt** ≤ 75,5 (аввал 39) |
...
| `.wcard__chip` | 22 pt, падинг `0 8`, радиус `--r-pill` 999 | `--t-small` **13/16**, 600 | фаол `--chip--brand` фон `--c-brand-soft` `#FFEDE7` / матн `--c-brand` `#FF4F28`; қолдирилган `--chip--pink` фон `--c-pink-soft` `#FFE4EA` / матн `--c-red` `#ED0000`; йиғма сон `--chip--brand` | Энди **фақат** `demo-active` (`Boshlandi`), `demo-missed` (`Kelmadi`) ва `multi` (`3 ta`) да қолди. Фаол чипда 6 pt `currentColor` нуқта (`.bk-dot--cur`) + матн, ора 4. Баландлик 22 pt қатъий, матн қатори 16 — сиғади, лекин захира 6 дан 3 pt га тушди |
| `.wcard__note` | ≤ 2 қатор (2×**16** + 8 + 8 = **48**), радиус `--r-inner` 12, падинг `8 10` | `--t-small` 500 **13/16** | демо `--note--brand` `#FFEDE7`, қолдирилган `--note--pink` `#FFE4EA`; матн `--c-text` `#000000` | Битта асосий факт ёки ҳолат матни. ≤ **74** белги (робот бўлса ≤ **50**) — аввалги 80/54 дан қисқарди |
| `.bk-list` (фақат `multi`) | 3 × 16 pt қатор, ора 2 = 52 | ном `--t-body` 500 **14/18**, сана `--t-small` 500 **13/16** | нуқта 6 pt: `--c-brand` `#FF4F28` демо, `--c-blue` `#1CB0F6` қўшимча дарс; сана `--c-text-2` `#999999` | Ном чапда «…» билан қисқаради, сана ўнгда сиқилмайди. ⚠️ CSS да `.bk-item { height: 16px }` **қатъий** ёзилган, матн қатори эса энди 18 pt — қатор қутисидан 2 pt чиқади (кесилмайди, `overflow` очиқ, лекин зич кўринади). Иловада қатор баландлиги **18** қилиниб, рўйхат 3×18 + 2×2 = **58** бўлсин — тана 77 pt га сиғади |
| `.bk-err` (фақат `error`) | 40 pt қатор, ора 10 | 500 **14/18** + 500 **13/16** | `--c-text`, `--c-text-2` | `robot4` 40×40 + икки қатор матн (18 + 16 = 34 ≤ 40 — робот баландлиги белгилайверади) |
| `.wcard__btn` | 36 pt, радиус `--r-btn` 12, падинг `0 14`, `flex: 1 1 auto` | `--t-btn` 600 **14/17** | фон `--c-brand` `#FF4F28`, матн `#FFFFFF`; хатода `--ghost` фон `--c-row` `#F8F8FC` / матн `--c-text` | Ягона асосий ҳаракат, ≤ **16** белги (аввал 18), 1 қатор `ellipsis`. Энг узуни `Hammasini ko'rish` (17) — ibtn сиз тўлиқ кенгликда сиғади |
...
| Скелет `.sk` | сарлавҳа 16×60 %, сатр 12×40 % (юқоридан 4), чип 84×22 (pill), изоҳ 46 (радиус 12), тугма 36 (`flex:1`), ibtn 32×32 (радиус 10) | — | `#EEF0F3 → #F6F7F9` градиент, 1,2 с | ⚠ Ҳозирги макетда скелет **эски** (чип + изоҳ) қолипини такрорлайди. Таймерли асосий ҳолатга мослаш учун чип олиб ташланиб, изоҳ ўрнида **55** pt таймер блоки турсин. Эслатма: `cards/extra.html` ва `cards/webinar.html` даги `.sk--timer` ҳамон **45** — уни ҳам 55 га келтириш керак |

Кенглик текшируви — **қайта ҳисобланди**. SF Pro тахминий метрикалари янги шкалада: 17/600 ≈ **9,4** pt/белги (аввал 15/600 ≈ 8,3), 13/600 ≈ **7,2** (аввал 12/600 ≈ 6,6), 13/500 ≈ **5,7** (аввал 12/500 ≈ 5,3), 14/500 ≈ **6,2**, 14/600 ≈ **7,7**. Қуйидаги рақамлар — шу нисбатлардаги **тахмин**, аниқ ўлчов эмас; рендерда бир марта текширилсин:

- Таймерли ҳолатларда сарлавҳа қаторида чип йўқ → `Demo Day` (≈ **75 pt**, аввал 66) бемалол сиғади; `demo-today` да `.bk-hpad` туфайли жой 268 pt, `Bugun, 14:00` (≈ **86 pt**, аввал 79) ва сарлавҳа шу ерга жойлашади.
- Энг оғир жуфтлик энди `demo-active`: `Demo Day` (75) + 8 + чип `Boshlandi` нуқта билан (≈ **91**) = **174** ≤ 320. Захира 161 дан 146 pt га тушди — ҳамон кенг.
- `Mening bandlovlarim` (19 белги) ≈ **179 pt**; `multi` да ёнида `3 ta` чипи (≈ **48 pt**) → 179 + 8 + 48 = 235 ≤ 320, сиғади.
- Таймер катаги 75,5 pt: икки хонали рақам 24/600 tabular ≈ **30 pt** (аввал 25), энг узун ёрлиқ `soniya` ≈ **43 pt** (аввал 39) — иккаласи ҳам сиғади, RU ёрлиқлари (`дн`, `ч`, `мин`, `сек`) ундан ҳам қисқа.
- Изоҳ тўлиқ кенгликда 13/500 да ≈ **45** белги/қатор (аввал 49), робот билан (248 pt) ≈ **36** белги/қатор (аввал 39) — икки қаторда **50** белгидан ошмасин.
- ⚠️ **RU да кесилиш хавфи.** `Вы пропустили Demo Day. Выберите новое время.` (45 белги) `demo-missed` да робот ёнида туради → лимит 2 × 36 = 72 белги, сиғади; аммо кирилл ҳарфлари лотиндан кенгроқ бўлгани учун захира кам. `Урок начался — Азиз Каримов ждёт вас.` (37 белги) роботсиз — хавфсиз. Икки қатордан ошса `line-clamp: 2` кесади — RU матнлари **50 белгидан** узун бўлмасин.
...
| `demo-today` | Тадбир куни бугун (Тошкент), ҳали бошланмаган | `Bugun, HH:mm`, таймер `--soon` кўринишида (апельсин фон ва рақамлар), `robot7` (бош бармоқ) **ўнг-юқорида 46 pt** — сарлавҳа устуни `.bk-hpad` олади, таймер эса роботнинг тагида (у 70 дан, робот 54 да тугайди — ораси 16 pt) бошлангани учун тўлиқ кенгликда қолади | `Demo Day` / `Bugun, 14:00` / `00 kun · 00 soat · 41 daqiqa · 20 soniya` / `Batafsil` | `Demo Day` / `Сегодня, 14:00` / `00 дн · 00 ч · 41 мин · 20 сек` / `Подробнее` |
...
`.s-timer` — карточкадаги `.wtimer` нинг катта варианти, `demo` панелининг танасида, «**Demoday kunga qolgan vaqt**» ҳинтидан кейин туради. Иккиси бир хил `data-cd` дан юрганлиги учун панел очилганда рақамлар карточкадагига мос келади.

| Элемент | Ўлчам | Шрифт | Ранг |
|---|---|---|---|
| `.s-timer` | 4 устун `1fr`, ора 8; панел танаси 358 pt кенг → ҳар катак `83,5×`**63** | — | — |
| `.s-timer__b` | падинг `10 0 9`, радиус 14 → 10 + 28 + 1 + 15 + 9 = **63** (аввал 62; ёрлиқ `--t-tiny` 14 дан 15 га ошди) | — | фон `--c-row` `#F8F8FC` |
| `.s-timer__b b` | 28 pt қатор | 600 24/28, letter-spacing −0.6, `tabular-nums` — CSS да **қатъий**, токенга боғлиқ эмас → **ўзгармади** (энди карточка рақами билан бир хил) | `--c-text` `#000000` |
| `.s-timer__b span` | **15 pt** қатор, юқоридан 1 | `--t-tiny` 500 **12/15** | `--c-text-2` `#999999` |
| `.s-timer--soon` | шу ўлчам | — | фон `--c-brand-soft` `#FFEDE7`, рақам `--c-brand` `#FF4F28` |

Ҳинт: `.s-hint` **12/15** (`--t-tiny`), `--c-text-2` `#999999`, иконка `time.svg` 13 pt `--c-slate` `#93A2C0`. Матни — «Demoday kunga qolgan vaqt».
...
Панел тугмаси `.s-btn`: 48 pt баланд, радиус 14, 600 15/18 (CSS да **қатъий** ёзилган, `--t-title` эмас → шрифт шкаласи ўзгарганда ҳам **ўзгармади**), фон `--c-brand` `#FF4F28` / матн `#FFFFFF`; `--ghost` `--c-row` `#F8F8FC` / `--c-text`; `--danger` `--c-pink-soft` `#FFE4EA` / `--c-red` `#ED0000`; `--disabled` `--c-line-2` `#F0F0F0` / `--c-text-3` `#B4B4B4`.

## 6. Расмлар ва иконкалар

| Файл | Қаерда | Ўлчам | Изоҳ |
|---|---|---|---|
| `images/robot7.png` | `demo-today` | **46 pt, ўнг-юқори** (`--art:46px`, `right 8 / top 8`) | Бош бармоқ — «тайёрсиз». Аввал 64 pt ўнг-пастда эди; таймер тананинг тўлиқ кенглигини эгаллагани учун робот сарлавҳа ёнига кўтарилди, сарлавҳа устуни `.bk-hpad` (52 pt) олади. Робот 8…54 y да, таймер эса марказлашгандан кейин **70 y** дан бошланади — ораси **16 pt** (аввал 1 pt) |
...
- **Таймер** — карточкада `Row` да 4 та `Expanded` (ора 6, `SizedBox(width: 6)` билан) → `Container(height: 55, padding: EdgeInsets.fromLTRB(0, 8, 0, 7), radius 12, color row)` + `Column[Text(24/600 h28, tabularFigures, ls −0.6), Text(10/500 h12, ls +0.3, uppercase, text3)]`. Таймер танада ягона элемент бўлгани учун тана `MainAxisAlignment.center` (CSS даги `.wcard__body:has(> .wtimer)`). Панелда шу қолип 24/28 рақам, `tiny` (12/15) ёрлиқ, падинг `10 0 9`, радиус 14, ора 8, баландлик 63 билан такрорланади. Ҳисоблаш, тик ва тўхтатиш мантиғи битта `CountdownController` да — [`spec/taymer.md`](taymer.md) га қаранг, бу ерда такрорланмайди. Рақамлар албатта `FontFeature.tabularFigures()` билан, акс ҳолда ҳар сонияда катак эни «сакрайди».
...
- **Изоҳ** — `Container(padding: 8 10, радиус 12, фон семантик)` + `Text(small, maxLines: 2, overflow: ellipsis)`. Баландлиги **48** га (2×16 + 16) қотирилмайди, лекин 2 қатор клампи бор.
- **Рўйхат** (`multi`) — `Column` 3 та қатор, ора 2; ном `Expanded` + `ellipsis`, сана `Text(small)`. 4+ бандловда учинчи қатор `+N ta yana`. ⚠️ Қатор баландлиги **16 эмас, 18** бўлсин: маketдаги `.bk-item { height: 16px }` эски 13/16 шрифтдан қолган, ном энди 14/18 — рўйхат 3×18 + 2×2 = **58 pt** (тана 77 pt га сиғади).
- **Скелет** — `shimmer` пакети ёки `AnimatedContainer` градиент 1,2 с; шакллар **асосий (таймерли) ҳолат** билан бир хил бўлсин: сарлавҳа 16, сатр 12, тана **55** pt битта блок, тугма 36 + ibtn 32.
