...
Карточка `304×178 pt` (`--card-w`/`--card-h`), падинг `12` (`--card-pad`) → ички қути `280×154`, радиус `--r-card` 18, фон `--c-card` `#FFFFFF`, соя `--shadow-card` `0 6 18 rgba(28,39,76,.06)`. Тик оқим, элементлар ораси `--s-2` 8 pt.
...
| **`.wtimer`** (таймерли ҳолатлар) | 280×45, 4 устун `1fr`, ора 6 → ҳар катак `65,5×45` | — | — | Чипнинг ўрнини босди. `data-cd="KK:SS:DD:SS"`, `js/app.js` `tickCountdowns()` ҳар 1 с да 4 та `<b>` ни янгилайди. Тўлиқ қоида — [`spec/taymer.md`](taymer.md) |
| `.wtimer__b` | 65,5 кенг, падинг `6 0 5`, радиус `--r-inner` 12 | — | фон `--c-row` `#F8F8FC` | 4 та бир хил катак: кун · соат · дақиқа · сония |
| `.wtimer__b b` (рақам) | 23 pt қатор | 600 20/23, letter-spacing −0.5, `tabular-nums` | `--c-text` `#000000` | Ҳар доим икки хона: `02`, `41` |
| `.wtimer__b span` (ёрлиқ) | 11 pt қатор | 500 9/11, letter-spacing +0.3, UPPERCASE | `--c-text-3` `#B4B4B4` | `kun` · `soat` · `daqiqa` · `soniya`. Энг узуни `soniya` ≈ 39 pt ≤ 65,5 |
...
- Таймерли ҳолатларда сарлавҳа қаторида чип йўқ → `Demo Day` (≈ 66 pt) бемалол сиғади; `demo-today` да `.bk-hpad` туфайли жой 228 pt, `Bugun, 14:00` (≈ 79 pt) ва сарлавҳа шу ерга жойлашади.
- Энг оғир жуфтлик энди `demo-active`: `Demo Day` (66) + 8 + чип `Boshlandi` нуқта билан (≈ 85) = 159 ≤ 280.
- Таймер катаги 65,5 pt: икки хонали рақам 20/600 tabular ≈ 25 pt, энг узун ёрлиқ `soniya` ≈ 39 pt — иккаласи ҳам сиғади, RU ёрлиқлари (`дн`, `ч`, `мин`, `сек`) ундан ҳам қисқа.
- Изоҳ тўлиқ кенгликда 12/500 ≈ 49 белги/қатор, робот билан (208 pt) ≈ 39 белги/қатор — икки қаторда 54 белгидан ошмасин.
