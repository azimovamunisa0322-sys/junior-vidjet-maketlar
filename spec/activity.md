...
|---|---|---|---|
| Карточка | 344×192, радиус 18, ички падинг 12 | — | оқ `#FFFFFF`, соя `0 6px 18px rgba(28,39,76,.06)` |
...
| 7 кун қатори | 320×42, ҳар устун қаторнинг 1/7 қисми (320 / 7 = 45,7 px) — оралиқ қолмайди, кенглик ўзгарса ҳам бузилмайди | — | — |
| Легенда қатори | 14 | 11/500 | нуқталар 8×8 радиус 3 |
| Тугма | 320×36, радиус 12 | 13/600 | `--c-brand` `#FF4F28`, матн оқ |
| Робот (бўш ҳолат) | 72×72, ўнг пастда | — | `robot3.png` |

Вертикал йиғинди: 33 (сарлавҳа + ой) + 8 + 56 (қатор + легенда) + 8 + 36 = 141 ≤ 168. Қўшилган 21 px тана (`.wcard__body`, flex) га тушади: бўш жой 6 → 27 px. Ҳамма ҳолат сиғади.
...
|---|---|---|
| `Kalendarni ochish` тугмаси | 320×44 | Пастки панелни очади (тўлиқ ой календари) |
| Кун катаги | 45,7×44 (устун кенглиги — қаторнинг 1/7 қисми) | Шу кун танланади, пастки панел ўша кун тафсилоти билан очилади. Келажак кунлар босилмайди |
| Чип | босилмайди | Фақат маълумот |
| `Darsni davom ettirish` / `Darsni boshlash` | 320×44 | Курс экранига ўтади (маршрут) |
| `Vazifani ko'rish` | 320×44 | Қайтарилган вазифа экранига ўтади |
...
- Карточка: `Container` (радиус 18, `BoxShadow`), карусел `PageView` ёки `ListView` + `SnapScrollPhysics`, кенглик 344, оралиқ 8, карточканинг чап чети саҳифадан 16 да (кулранг банд чапдан 12 да бошланади, трекнинг чап падинги 4). Банд баландлиги 200 — кулранг фон карточкани тепа-пастдан атиги 4 pt билан ўрайди; нуқталар банддан **ташқарида**, унинг остида (margin-top 10, баландлиги 19).
- 7 кун қатори: `Row` ичида 7 × `Expanded(flex: 1)` — ҳар устун қаторнинг 1/7 қисми (320 / 7 = 45,7), қатъий кенглик берилмасин; ҳар кун `Column` (катак `Container` 26×26 радиус 9, ёзув `Text`).
