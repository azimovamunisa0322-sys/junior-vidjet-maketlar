...
|---|---|---|---|
| Карточка | 304×178, радиус 18, ички падинг 12 | — | оқ `#FFFFFF`, соя `0 6px 18px rgba(28,39,76,.06)` |
...
| 7 кун қатори | 280×42, кунлар орасида тенг оралиқ (39 px устун, орада ~1.2 px) | — | — |
| Легенда қатори | 14 | 11/500 | нуқталар 8×8 радиус 3 |
| Тугма | 280×36, радиус 12 | 13/600 | `--c-brand` `#FF4F28`, матн оқ |
...
|---|---|---|
| `Kalendarni ochish` тугмаси | 280×44 | Пастки панелни очади (тўлиқ ой календари) |
...
| `Darsni davom ettirish` / `Darsni boshlash` | 280×44 | Курс экранига ўтади (маршрут) |
| `Vazifani ko'rish` | 280×44 | Қайтарилган вазифа экранига ўтади |
...
- Карточка: `Container` (радиус 18, `BoxShadow`), карусел `PageView` ёки `ListView` + `SnapScrollPhysics`, кенглик 304, оралиқ 7, ён падинг 43.
