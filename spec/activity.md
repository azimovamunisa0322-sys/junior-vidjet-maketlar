...
|---|---|---|---|
| Карточка | 332×178, радиус 18, ички падинг 12 | — | оқ `#FFFFFF`, соя `0 6px 18px rgba(28,39,76,.06)` |
...
| 7 кун қатори | 308×42, 7 устун × 44 px = 308 — оралиқ қолмайди | — | — |
| Легенда қатори | 14 | 11/500 | нуқталар 8×8 радиус 3 |
| Тугма | 308×36, радиус 12 | 13/600 | `--c-brand` `#FF4F28`, матн оқ |
| Робот (бўш ҳолат) | 72×72, ўнг пастда | — | `robot3.png` |

Вертикал йиғинди: 33 (сарлавҳа + ой) + 8 + 56 (қатор + легенда) + 8 + 36 = 141 ≤ 154. Қўшилган 7 px тана (`.wcard__body`, flex) га тушади: бўш жой 6 → 13 px. Ҳамма ҳолат сиғади.
...
|---|---|---|
| `Kalendarni ochish` тугмаси | 308×44 | Пастки панелни очади (тўлиқ ой календари) |
| Кун катаги | 44×44 (устун кенглиги) | Шу кун танланади, пастки панел ўша кун тафсилоти билан очилади. Келажак кунлар босилмайди |
| Чип | босилмайди | Фақат маълумот |
| `Darsni davom ettirish` / `Darsni boshlash` | 308×44 | Курс экранига ўтади (маршрут) |
| `Vazifani ko'rish` | 308×44 | Қайтарилган вазифа экранига ўтади |
...
- Карточка: `Container` (радиус 18, `BoxShadow`), карусел `PageView` ёки `ListView` + `SnapScrollPhysics`, кенглик 332, оралиқ 8, ён падинг 16.
