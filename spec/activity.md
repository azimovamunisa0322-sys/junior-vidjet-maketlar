...
| Сарлавҳа `Faollik kalendari` | баландлик **21** | **17/600** SF Pro (`--t-title`) | `--c-text` `#000000` |
| Ой ёзуви `Sentabr 2026` | баландлик **16** (устидан `margin-top 2`) | **13/500** (`--t-small`) | `--c-green-2` `#58CC02` (оддий ҳолат), `--c-brand` огоҳлантиришда, `--c-red` хатода |
| Чип (ўнг юқорида) | баландлик 22, падинг 8 | **13/600** | фон/матн ҳолатга қараб: яшил `--c-green-soft`/`#58CC02`, пушти `--c-pink-soft`/`#ED0000`, нейтрал `--c-row`/`#999999` |
| Кун катаги | 26×26, радиус 9 | **12/600 lh 1** — `cards/activity.html` да **қатъий**, токен эмас → **ўзгармади** | ҳолат ранги (пастдаги жадвал) |
| Кун ёзуви `Du…Ya` | **15** | **12/500** (`--t-tiny`) | `--c-text-2` `#999999`, бугун `--c-brand` 600 |
| 7 кун қатори | 320×**43** (26 катак + 2 оралиқ + **15** ёзув), ҳар устун қаторнинг 1/7 қисми (320 / 7 = 45,7 px) — оралиқ қолмайди, кенглик ўзгарса ҳам бузилмайди. ⚠️ CSS да `.wk { height: 42px }` **қатъий** — кун ёзуви 14 дан 15 pt га ўсгач мазмун 1 pt чиқади, иловада баландлик **43** қилинсин | — | — |
| Легенда қатори | **15** | **12/500** (`--t-tiny`) | нуқталар 8×8 радиус 3 |
| Тугма | 320×36, радиус 12 | **14/600** (`--t-btn`) | `--c-brand` `#FF4F28`, матн оқ |
| Робот (бўш ҳолат) | 72×72, ўнг пастда | — | `robot3.png` |

Вертикал йиғинди — **қайта ҳисобланди** (ички қути 168). Сарлавҳа қатори энди **39** (21 + `margin-top` 2 + 16; аввал 35, спекда 33 деб ёзилган эди), тана мазмуни **64** (қатор 43 + `gap` 6 + легенда 15; аввал 62), пастки қатор 36, оралиқлар 2×8.

`39 + 8 + 64 + 8 + 36 = 155 ≤ 168`. Тана `flex: 1` бўлгани учун **77 pt** олади, мазмуни 64 → `justify-content: center` билан тепа-пастдан **6,5 pt** бўшлиқ (аввал 9,5). Ҳамма ҳолат сиғади, тошиш йўқ.

Бўш/хато ҳолатларида (`.st`) матн блоки **34 pt** (ном 18 + изоҳ 16) — 32 pt иконкадан баланд, қатор баландлигини энди матн белгилайди.

> ⚠️ `.wk` CSS да 42 pt га қотирилган, ҳақиқий мазмун эса 43 — иловада 43 қилинсин (1 pt, лекин кун ёзуви пастдан қирқилиб кўринмасин).
