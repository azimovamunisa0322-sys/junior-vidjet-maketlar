...
| **`.ck-hero` — вазифа блоки** | кенглиги **320 pt** (тўлиқ ички қути), баландлиги **57 pt** (9 + 24 + 15 + 9), радиус 12 (`--r-inner`), padding `9 10 9 13` | — | фон `--c-brand-soft` `#FFEDE7`; чап чекка чизиғи `box-shadow: inset 3px 0 0` `--c-brand` `#FF4F28` | карточканинг қаҳрамони; чапда матн устуни, ўнгда чип ёки иконка (оралиқ 8) |
| `.ck-hero__name` вазифа номи | 1 қатор 24 pt, эллипсис; устун кенглиги **229 pt** (тангали чип билан), 265 pt (`checking.svg` билан), 263 pt (`coin.png` билан) | `--t-num` 20/600, `letter-spacing −0.3` | `--c-text` `#000000` | ҳозирги (биринчи бажарилмаган) вазифа номи |
...
Баландлик ҳисоби. Асосий ҳолатлар (`not-started`, `in-progress`, `due-soon`, `reward-ready`, `loading`): 12 + 22 (бош) + 8 + **69** (тана: hero 57 + 6 + прогресс 6) + 8 + 36 (тугма) + 12 = **167**; `.wcard__body` `flex: 1` бўлгани учун тана 69 → 94 га чўзилади (қўшимча 25 pt тананинг ўзига тушади) ва `justify-content: center` билан тепа-пастдан 12,5 pt бўшлиқ қолдиради — жами аниқ 192. Hintли ҳолатлар (`awaiting-check`, `claimed`): 12 + 22 + 8 + 69 + 8 + 14 + 12 = **145**, ортиқча 47 pt танага тушади. `no-tasks`: 12 + 32 + 8 + 46 + 8 + 36 + 12 = **154**, ортиқча 38 pt танага тушади. `error`: 12 + 14 + 8 + 46 + 8 + 36 + 12 = **136**, ортиқча 56 pt танага тушади. Ҳаммаси лимит (192) ичида, ҳеч бири тошмайди.
...
Матн узунлиги (SF Pro файллари билан ўлчанган, pt). Бош қатор: ёрлиқ `KUNLIK VAZIFALAR` 111 + нуқта ва оралиқлар 15 + вақт `7 soat qoldi` 53 + 8 + чип `0/3` 39 = **226 ≤ 320** (94 pt заҳира). RU'да `ЕЖЕДНЕВНЫЕ ЗАДАНИЯ` 143 pt — тўлиқ сатр 293 pt, янги 320 pt кенгликка сиғади (27 pt заҳира), шунинг учун RU'да ҳам тўлиқ ёрлиқ ишлатилади. Вазифа номи 20/600 устунда 229 pt: `Blockly Dasturlash` 165, `Grafik dizayn` 117, `+30 coin olindi` 132, `Barakalla!` 88 — сиғади; RU `Графический дизайн` 199 pt — 229 pt устунга сиғади (`awaiting-check` да 265 pt), узун курс номлари эса кесилади — кутилган хатти-ҳаракат, тўлиқ ном пастки панелда. Тури 12/500: `Amaliy vazifa · oxirgisi qoldi` 144, RU `Домашнее задание · 15 минут` 162, `Практика · осталась последняя` 171 — ҳаммаси 229 га сиғади.
