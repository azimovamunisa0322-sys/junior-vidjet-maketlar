...
Карточка: 332×178 pt, ички padding 12 → ички қути 308×154 pt, радиус 18 (`--r-card`), фон `--c-card` `#FFFFFF`, соя `--shadow-card`. Ички блоклар вертикал устун, оралиқ 8 pt (`--s-2`). Тана ичида оралиқ 6 pt ва `justify-content: center`. Бутун карточка босилади (пастки панел очади).
...
| `.ck-hero__name` вазифа номи | 1 қатор 24 pt, эллипсис; устун кенглиги **217 pt** (тангали чип билан), 253 pt (`checking.svg` билан), 251 pt (`coin.png` билан) | `--t-num` 20/600, `letter-spacing −0.3` | `--c-text` `#000000` | ҳозирги (биринчи бажарилмаган) вазифа номи |
...
| `.wcard__progress` | 6 pt, радиус 3, тўлиқ кенглик 308 | — | трек `--c-line-2` `#F0F0F0`, тўлдириш `--c-brand` `#FF4F28`; `--green` вариантда `--c-green` `#0CD678` | уч нуқтали степпер ўрнига; кенглик = `done/total` (0 / 33.3 % / 66.6 % / 100 %) |
...
Баландлик ҳисоби. Асосий ҳолатлар (`not-started`, `in-progress`, `due-soon`, `reward-ready`, `loading`): 12 + 22 (бош) + 8 + **69** (тана: hero 57 + 6 + прогресс 6) + 8 + 36 (тугма) + 12 = **167**; `.wcard__body` `flex: 1` бўлгани учун тана 69 → 80 га чўзилади (қўшимча 11 pt тананинг ўзига тушади) ва `justify-content: center` билан тепа-пастдан 5,5 pt бўшлиқ қолдиради — жами аниқ 178. Hintли ҳолатлар (`awaiting-check`, `claimed`): 12 + 22 + 8 + 69 + 8 + 14 + 12 = **145**, ортиқча 33 pt танага тушади. `no-tasks`: 12 + 32 + 8 + 46 + 8 + 36 + 12 = **154**, ортиқча 24 pt танага тушади. `error`: 12 + 14 + 8 + 46 + 8 + 36 + 12 = **136**, ортиқча 42 pt танага тушади. Ҳаммаси лимит (178) ичида, ҳеч бири тошмайди.
...
Матн узунлиги (SF Pro файллари билан ўлчанган, pt). Бош қатор: ёрлиқ `KUNLIK VAZIFALAR` 111 + нуқта ва оралиқлар 15 + вақт `7 soat qoldi` 53 + 8 + чип `0/3` 39 = **226 ≤ 308** (82 pt заҳира). RU'да `ЕЖЕДНЕВНЫЕ ЗАДАНИЯ` 143 pt — тўлиқ сатр 293 pt, янги 308 pt кенгликка сиғади (15 pt заҳира), шунинг учун RU'да ҳам тўлиқ ёрлиқ ишлатилади. Вазифа номи 20/600 устунда 217 pt: `Blockly Dasturlash` 165, `Grafik dizayn` 117, `+30 coin olindi` 132, `Barakalla!` 88 — сиғади; RU `Графический дизайн` 199 pt — 217 pt устунга сиғади (`awaiting-check` да 253 pt), узун курс номлари эса кесилади — кутилган хатти-ҳаракат, тўлиқ ном пастки панелда. Тури 12/500: `Amaliy vazifa · oxirgisi qoldi` 144, RU `Домашнее задание · 15 минут` 162, `Практика · осталась последняя` 171 — ҳаммаси 217 га сиғади.
...
- Карточка: `Container` (`BoxDecoration`: радиус 18, соя `0 6 18 rgba(28,39,76,.06)`, оқ фон) → `Padding(12)` → `Stack` (робот фақат `no-tasks` да: `Positioned(right: 8, bottom: 8)`) → `Column` (`crossAxisAlignment.stretch`, оралиқ 8 `SizedBox`). Ўлчам ота каруселдан келади (332×178); тана `Expanded` (ичида `MainAxisAlignment.center`), футер пастда.
