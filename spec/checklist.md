...
Карточка: 304×178 pt, ички padding 12 → ички қути 280×154 pt, радиус 18 (`--r-card`), фон `--c-card` `#FFFFFF`, соя `--shadow-card`. Ички блоклар вертикал устун, оралиқ 8 pt (`--s-2`). Тана ичида оралиқ 6 pt ва `justify-content: center`. Бутун карточка босилади (пастки панел очади).
...
| `.ck-hero__name` вазифа номи | 1 қатор 24 pt, эллипсис; устун кенглиги **189 pt** (тангали чип билан), 225 pt (`checking.svg` билан), 223 pt (`coin.png` билан) | `--t-num` 20/600, `letter-spacing −0.3` | `--c-text` `#000000` | ҳозирги (биринчи бажарилмаган) вазифа номи |
...
| `.wcard__progress` | 6 pt, радиус 3, тўлиқ кенглик 280 | — | трек `--c-line-2` `#F0F0F0`, тўлдириш `--c-brand` `#FF4F28`; `--green` вариантда `--c-green` `#0CD678` | уч нуқтали степпер ўрнига; кенглик = `done/total` (0 / 33.3 % / 66.6 % / 100 %) |
...
Матн узунлиги (SF Pro файллари билан ўлчанган, pt). Бош қатор: ёрлиқ `KUNLIK VAZIFALAR` 111 + нуқта ва оралиқлар 15 + вақт `7 soat qoldi` 53 + 8 + чип `0/3` 39 = **226 ≤ 280** (54 pt заҳира). RU'да `ЕЖЕДНЕВНЫЕ ЗАДАНИЯ` 143 pt — тўлиқ сатр 293 pt га чиқади ва вақт кесилади, шунинг учун RU ёрлиғи **`ЗАДАНИЯ ДНЯ`** (86 pt, сатр 236 pt). Вазифа номи 20/600 устунда 189 pt: `Blockly Dasturlash` 165, `Grafik dizayn` 117, `+30 coin olindi` 132, `Barakalla!` 88 — сиғади; RU `Графический дизайн` 199 pt `in-progress` да `…` билан кесилади (`awaiting-check` да 225 pt устунга сиғади), узун курс номлари ҳам кесилади — кутилган хатти-ҳаракат, тўлиқ ном пастки панелда. Тури 12/500: `Amaliy vazifa · oxirgisi qoldi` 144, RU `Домашнее задание · 15 минут` 162, `Практика · осталась последняя` 171 — ҳаммаси 189 га сиғади.
...
- Карточка: `Container` (`BoxDecoration`: радиус 18, соя `0 6 18 rgba(28,39,76,.06)`, оқ фон) → `Padding(12)` → `Stack` (робот фақат `no-tasks` да: `Positioned(right: 8, bottom: 8)`) → `Column` (`crossAxisAlignment.stretch`, оралиқ 8 `SizedBox`). Ўлчам ота каруселдан келади (304×178); тана `Expanded` (ичида `MainAxisAlignment.center`), футер пастда.
