...
|---|---|---|---|---|
| `.wcard__head` | баландлик 22 (чип бўйича) — **ўзгармади**: сарлавҳа қатори 18 дан **21** га чиққан бўлса ҳам чип (22) ҳамон баландроқ. `error` да чип йўқ → **21** (аввал 18) | — | — | чапда сарлавҳа, ўнгда чип; `align-items: flex-start` |
| `.wcard__title` «Tavsiya etilgan kurs» | 1 қатор **21 pt**, ≤ **19** белги | **17/600, line-height 21** (`--t-title`) | `--c-text` `#000000` | ўзгармас карточка номи (20 белги — энди чегарада); бэкенд `title` келса ва ≤ **19** белги бўлса алмаштиради (қ. 3-бўлим изоҳи) |
| `.wcard__chip` ҳолат чипи | баландлик 22, падинг 0 8, пилл | **13/600** | `not-started`: фон `--c-row` `#F8F8FC`, матн `--c-text-2` `#999999` (slate = ноактив); `in-progress`: `--chip--brand` фон `--c-brand-soft` `#FFEDE7`, матн `--c-brand` `#FF4F28` | матн: `Boshlanmagan` ёки фоиз `45%` |
| `.wcard__body` | флекс устун, `gap` 6, мазмуни макс. **54** | — | — | `.rc-row` (**42**) + `gap` 6 + прогресс 6 = **54** |
| `.rc-row` | баландлик **42**, `gap` 10 | — | — | эскиз + матн устуни. CSS да `min-height: 40` — аввал баландликни эскиз (40) белгиларди, энди матн устуни (ном 26 + сатр 16 = **42**) баландроқ |
...
| `.rc-name` курс номи (`.wcard__num`) | 1 қатор **26 pt**, устун кенглиги 240 pt, `…` | **22/600, line-height 26** (`--t-num`), letter-spacing −0.3 | `--c-text` | ≈ **16–18** лотин белги сиғади (аввал 18–20); тўлиқ ном варақда |
| `.rc-cap` ҳолат сатри (`.wcard__muted`) | 1 қатор **16 pt**, `…` | **13/500, line-height 16** (`--t-small`) | `--c-text-2` `#999999` | `Sizga mos kurs` / `Davom etmoqda` |
...
| `.wcard__btn` асосий тугма | баландлик 36, радиус 12, падинг 0 14 | **14/600** (`--t-btn`) | фон `--c-brand`, матн `#FFFFFF` | матн + `arrow_right.svg` 16×16 оқ (маршрутга ўтиш шеврони) |
| `.wcard__ibtn` «i» тугма | `32×32`, радиус 10 | «i» **14/600 lh 1** — `.rc-i` да **қатъий** ёзилган, токен эмас → **ўзгармади** | фон `--c-row`, ҳарф `--c-slate` `#93A2C0` | босиш зонаси ≥ 44 pt (Flutter'да падинг билан) |
| `.wcard__btn--ghost.wcard__btn--fit` (хато) | баландлик 36, контент кенглиги | **14/600** | фон `--c-row`, матн `--c-text` | «Qayta urinish» |
...
Баландлик ҳисоби — **қайта ҳисобланди** (ички қути 168). Сарлавҳа қатори чип билан **22** pt да қолди (сарлавҳа 21 < чип 22), фақат `error` да 18 → **21**. Матн ўлчамлари ўсгани учун `.rc-row` 40 → **42**, `error` матн блоки 37 → **40**.

- `in-progress` (энг тўлиқ): head 22 + 8 + body **54** (қатор 42 + 6 + прогресс 6) + 8 + foot 36 = **128 ≤ 168**, бўш жой **40** pt.
- `not-started`: 22 + 8 + **42** + 8 + 36 = **116**, бўш жой **52** pt.
- `error`: **21** + 8 + (**18** + 6 + **16** = 40) + 8 + 36 = **113**, бўш жой **55** pt.

Қолган жой ҳар ҳолатда `.wcard__body` га (`flex: 1`) тушади, футер пастга ёпишади. Ҳеч бир ҳолатда тошиш йўқ — энг тор ҳолатда ҳам 40 pt захира бор.

> Скелет (`.sk`) даги ном чизиғи 20 pt — ҳақиқий ном қатори энди **26**; иловада скелет 26 га келтирилсин (2 pt эмас, 6 pt фарқ — юклашдан ҳақиқий ҳолатга ўтганда сезилади).

Матн узунлиги — **қайта ҳисобланди** (эски CoreText ўлчовлари янги шрифт нисбатига кўпайтирилди: сарлавҳа ×17/15, чип ×13/12, ном ×22/20. Рақамлар **тахмин** — рендерда текширилсин).

**Сарлавҳа қатори:** сарлавҳа 17/600 ≈ **150 pt** (аввал 132), RU «Рекомендуемый курс» ≈ **177** (аввал 156); чип «Boshlanmagan» ≈ **106** (аввал 98), «Не начат» ≈ **74**. Энг оғир жуфтлик — RU: 177 + 8 + 74 = **259 ≤ 320**, захира 61 pt; UZ: 150 + 8 + 106 = **264**, захира 56 pt. Иккаласи ҳам сиғади.

**Курс номи** (энди 22/600) 240 pt устунда: «Web dasturlash» ≈ **152** (аввал 138), «Matematika» ≈ **116**, «Grafik dizayn» ≈ **128**, «Blockly Dasturlash» ≈ **180**, «Веб-разработка» ≈ **168** — ҳаммаси сиғади.

> ⚠️ **RU да чегарага яқин.** «Графический дизайн» 198 → **≈ 218 pt**, устун 240 pt — захира 42 дан **22 pt** га тушди. Ҳали сиғади, лекин ундан узунроқ RU номлари энди кесилади. 30–50 белгили реал номлар аввалгидек `…` билан кесилади («Grafik dizayn va animatsiya asoslari» → «Grafik dizayn va an…» — аввал «…animat…» гача сиғарди) — бу кутилган хатти-ҳаракат, тўлиқ ном варақда, лекин кесилиш нуқтаси икки-уч белгига эртароқ келади.
...
| «i» | матн ҳарфи, иконка йўқ | 14/600 (қатъий, ўзгармади), `--c-slate` | `.wcard__ibtn`; иловада `info` иконкаси йўқ |
...
- **Токенлар:** `ThemeExtension<JuniorTokens>` — `card`, `row`, `line2`, `text`, `text2`, `slate`, `brand`, `brandSoft`, `red`, радиуслар `rCard 18 / rInner 12 / rBtn 12`, `TextStyle` лар **янги шкала** бўйича: `title 17w600/21`, `num 22w600/26`, `body 14w500/18`, `small 13w500/16`, `tiny 12w500/15`, `btn 14w600/17`; `.rc-i` даги «i» эса қатъий `14w600/1` — ўзгармайди; шрифт `SFpro` 400/500/600 (`pubspec` да мавжуд).
