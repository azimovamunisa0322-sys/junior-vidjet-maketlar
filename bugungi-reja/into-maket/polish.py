...
/* ---------- 4. To'ldirilgan tugmalar: brend rangi qoladi ----------
   Sinab ko'rildi va QAYTARILDI. Oq matn #FF4F28 fonda 3.28 beradi,
   AA esa 4.5 talab qiladi. Lekin hisob shuni ko'rsatdi: oq matn uchun
   AA dan o'tadigan ENG YORQIN apelsin — #DD390F (4.50), ya'ni brend
   rangidan sezilarli to'q. Bunday to'q variant maketda og'ir ko'rindi.

   Qaror: to'ldirilgan tugmalarda brend rangi #FF4F28 QOLADI.
   3.28 — WCAG ning «katta matn / UI komponenti» chegarasidan (3.0)
   o'tadi va amalda o'qiladi, chunki bu yirik, to'liq bo'yalgan yuza.
   Haqiqiy o'qish muammosi ingichka kulrang matnlarda edi (2.0–2.4) —
   ular tuzatildi va 4.9+ ga chiqdi.

   Agar kelajakda qat'iy AA kerak bo'lsa, yagona yo'l — tugma yozuvini
   18.66 px bold yoki 24 px ga kattalashtirish; o'shanda talab 3.0 ga
   tushadi va brend rangi o'zgarmay qoladi. */
